...
class ADE20KDataset(Pix2pixDataset):
    ...
    # TODO: 将get_paths改为适配train_resized的形式
    def get_paths(self, opt):
        ...
        all_images = sorted(make_dataset(root + '/' + image_subfolder, recursive=True, read_cache=cache, write_cache=False))

        label_subfolder = 'labels'
        all_labels = sorted(make_dataset(root + '/' + label_subfolder, recursive=True, read_cache=cache, write_cache=False))
