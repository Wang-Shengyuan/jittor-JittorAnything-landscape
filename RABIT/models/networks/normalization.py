...
def get_nonspade_norm_layer(opt, norm_type='instance'):
    ...
    def get_out_channel(layer):
        ...
        if isinstance(layer, spectral_norm):
            return getattr(layer.module, 'out_channels')
...
class SEACE(nn.Module):
    def __init__(self, config_text, norm_nc, label_nc, PONO=False, use_apex=False, feat_nc=None, atten=False):
        ...
        self.coef = nn.Parameter(jt.tensor(0.), requires_grad=True)
...
class EqualLR:
    ...
    def apply(module, name):
        ...
        setattr(module, name + '_orig', nn.Parameter(weight.data))
