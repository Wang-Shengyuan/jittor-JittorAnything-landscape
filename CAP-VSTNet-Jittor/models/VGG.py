...
def build_vgg():
    vgg = nn.Sequential(
        ...
        nn.Conv(64, 64, (3, 3)),
        nn.ReLU(),  # relu1-2
        nn.Pool((2, 2), stride=(2, 2), padding=(0, 0), ceil_mode=True, op='maximum'),
        nn.ReflectionPad2d((1, 1, 1, 1)),
        nn.Conv(64, 128, (3, 3)),
        nn.ReLU(),  # relu2-1
        nn.ReflectionPad2d((1, 1, 1, 1)),
...
class VGG19(nn.Module):
    ...
    def __init__(self, checkpoint):
        ...
        vgg = build_vgg()
        vgg.load_parameters(jt.load(checkpoint))
    ...
    def execute(self, content_images, style_images, stylized_images, n_layer=4, content_weight=0):
